...
public class PetCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String pet_name = cursor.getString(cursor.getColumnIndex(PetEntry.COLUMN_PET_NAME));
        String pet_breed = cursor.getString(cursor.getColumnIndex(PetEntry.COLUMN_PET_BREED));
